...
def walk_dirs_start_str(path, str_start, full=True):
    """Return list[str] names of the dirs, start with str_start, multi-under path without path itself."""
...
def walk_files_end_str(path, str_end, full=True):
    """Return list[str] dir and file names, end with str_end, multi-under path without path itself."""
...
def mycopyfile(srcfile, dstfile):
    ...
    if not os.path.isfile(srcfile):
        ...
        fpath, _ = os.path.split(dstfile)  # split path and filename
